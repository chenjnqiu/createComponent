...
export declare type IconType = 'subtract-circle-o' | 'close-circle-o' | 'check-circle-o' | 'search' | 'bell-o' | 'customer-o' | 'down' | 'up' | 'settings-o' | 'plus-circle-o' | 'reverse' | 'forward' | 'closed' | 'lock' | 'delete' | 'menu' | 'position' | 'arrow-right' | 'arrow-left' | 'prompt';
